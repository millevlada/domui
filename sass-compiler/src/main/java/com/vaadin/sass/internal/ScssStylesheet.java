...
public class ScssStylesheet extends Node {
	 ...
	 *
	 * @param identifier The file path. If null then null is returned.
	 * @return
	 * @throws CSSException
	 * @throws IOException
	 */
	 ...
	 *
	 * @param identifier       The file path. If null then null is returned.
	 * @param parentStylesheet Style sheet from which to inherit resolvers and encoding. May
	 *                         be null.
	 * @return
	 * @throws CSSException
	 * @throws IOException
	 ...
	 * @param parentStylesheet Style sheet from which to inherit resolvers and encoding. May
	 *                         be null.
	 * @param documentHandler  Instance of document handler. May not be null.
	 * @param errorHandler     Instance of error handler. May not be null.
	 * @return
	 * @throws CSSException
	 * @throws IOException
	 */
	...
	public InputSource resolveStylesheet(String identifier,
		...
		for(ScssStylesheetResolver resolver : getResolvers()) {
			...
			if(source != null) {
				File f = new File(source.getURI());         // jal: Bad, bad, bad: this assumes we're working with files- and we might not
				setFile(f);
				return source;
			}
		}
	 ...
	 * Applies all the visitors and compiles SCSS into Css.
	 *
	 * @param urlMode Specifies whether urls appearing in an scss style sheet are
